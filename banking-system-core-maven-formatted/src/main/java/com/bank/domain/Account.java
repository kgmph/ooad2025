...
public abstract class Account {
    ...
    protected final LocalDate openedAt = LocalDate.now();
    ...
    public void deposit(BigDecimal amount, String note) {
        requirePositive(amount); balance = balance.add(amount);
    ...
    public void withdraw(BigDecimal amount, String note) {
        ...
        if (balance.compareTo(amount) < 0) throw new BankExceptions.InsufficientFunds(accountNo);
